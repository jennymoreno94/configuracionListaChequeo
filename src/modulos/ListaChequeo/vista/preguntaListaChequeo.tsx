...
import { IPreguntaListaChequeoProps } from "../interfaces";
...
const PreguntaListaChequeoVista: React.FunctionComponent<IPreguntaListaChequeoProps> = () => {
...
export default PreguntaListaChequeoVista;